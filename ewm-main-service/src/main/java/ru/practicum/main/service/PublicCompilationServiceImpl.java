...
public class PublicCompilationServiceImpl implements PublicCompilationService {
    ...
    @Override
    public List<Compilations> getCompilations(Boolean pinned, int from, int size) {
    ...
    public CompilationShort getCompilationById(long compId) {
        Compilations compilations = repository.findById(compId).orElseThrow(() -> new NotFoundException("This compilation does not exist"));
