...
public class AdminCompilationsServiceImpl implements AdminCompilationsService {
    ...
    public void deleteCompilation(long compId) {
        ...
        if (!answer) {
            throw new NotFoundException("There is no such compilation");
        }
    ...
    public CompilationShort patchCompilation(long compId, NewCompilation newCompilation) {
        Compilations compilations = repository.findById(compId).orElseThrow(() -> new NotFoundException("There is no such compilation"));
